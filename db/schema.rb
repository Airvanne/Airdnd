...
ActiveRecord::Schema.define(version: 2018_10_25_222644) do
  ...
  create_table "dog_sitters", force: :cascade do |t|
    ...
    t.index ["dogs_id"], name: "index_dog_sitters_on_dogs_id"
  end
  ...
  create_table "dogs", force: :cascade do |t|
    ...
    t.index ["dog_sitters_id"], name: "index_dogs_on_dog_sitters_id"
  end
